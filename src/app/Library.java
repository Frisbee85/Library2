...
public class Library {
    public static void main(String[] args) {
        ...
        final String appName = "Bibioteka v 0.5";

        Book book1 = new Book("W pustyni i w puszczy", "Henryk Sienkiewicz", 2010, 298, "PWN", "9788373271890");
        ...
        System.out.println("Książki dostępne w bibiotece: ");
        book1.printInfo();
        book2.printInfo();
        book3.printInfo();
    }
